                ...
                <div key={film.id} className="relative">
                  <div className="relative min-h-[640px] w-[245px]">
                    ...
                    <div className="h-[150px]">
                      ...
                      <div className="flex w-[200px] items-center justify-between space-x-3 text-[11px] text-[#8E8E8E]">
                        <span className="truncate inline-block max-w-[100px]" title={cate?.category_names}>
                          {cate?.category_names}
                        </span>
                        {avgFilm?.star ? (
